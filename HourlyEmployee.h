...
class HourlyEmployee : public Employee
{
    ...
    cout << endl <<getEmployeeName()<< endl; 
		cout << endl << "Address: " << getEmployeeAddress() << endl;
		cout <<  "Payroll period: " << getPayStartDate() <<  " to " << getPayEndDate() << endl;
		cout << "Wage: $" << setprecision(2) << fixed <<getHoursWage() <<  endl;
		cout << "Total hours: " << setprecision(2) << fixed <<getHoursWorked() << endl;
		cout << "Total payroll: " << calcPay() << endl;
				cout<< endl <<"--------********--------------***********----------------************-----------"<< endl;
